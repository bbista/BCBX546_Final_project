...
annotated.diff$class_code <- NULL #removes unwanted columns
annotated.diff$nearest_ref_id <- NULL
annotated.diff$length <- NULL
annotated.diff$coverage <- NULL
annotated.diff$feature_id <- NULL
annotated.diff$isoform_id <- NULL
annotated.diff$seqnames <- NULL
annotated.diff$source <- NULL
annotated.diff$type <- NULL
annotated.diff$start <- NULL
annotated.diff$end <- NULL
annotated.diff$score <- NULL
annotated.diff$strand <- NULL
annotated.diff$frame <- NULL
head(annotated.diff)
```
```{r}
write_csv(annotated.diff, "./annotated.diff.csv")
```
